<h1><?php echo Yii::t('main', 'New order');?>!</h1>
<h3><?php echo Yii::t('site', 'Order');?> № <?php echo $order->o_id;?></h3>

<p><strong><?php echo Yii::t('main', 'User Name');?>:</strong>  <?php echo $user->u_fio;?></p>
<p><strong><?php echo Yii::t('main', 'User Phone');?>:</strong>  <?php echo $user->u_phone;?></p>
<p><strong><?php echo Yii::t('main', 'User Email');?>:</strong>  <?php echo $user->u_email;?></p>
