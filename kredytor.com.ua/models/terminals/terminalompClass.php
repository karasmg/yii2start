<?php
class terminalompClass extends paysystemClass {
	public $_paysys = 'terminal_omp';
    ...
    private $_LOGIN         = 'ompterminal';
	private $_PASSWORD      = 'PQfT9Co01G6';
	...
	protected function checkSign() {
        if($this->_request['login'] == $this->_LOGIN && $this->_request['password'] == $this->_PASSWORD) return true;
        else return false;
	}
	...
	public function output($error, $data = null, $exit = true) {
        ...
        $response.= '	<response>';
        $response.= '		<osmp_txn_id>'.$this->_request['txn_id'].'</osmp_txn_id>';
